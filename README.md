...
cd nginx-quic-lb
./auto/configure <flags [See note 1]>
make
sudo make install
...
stream {
    upstream server_pool {
        quic-lb cr=0 sidl=4; [See note 2]
        ...
        server <addr>:<port> sid0=01234567 sid1=89abcdef0123 sid2=456789ab; [See note 3]
